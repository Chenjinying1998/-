...
<div class="panel admin-panel">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>查看班级学生宿舍分配情况</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="${ctx}/statis/viewdisbycla.action">  
        <div class="label" >
          <label>选择待查看的班级：</label>
        </div>
		<div>
